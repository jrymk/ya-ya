...
g++ -c ..\src\controls.cpp -I..\SFML-2.5.1\include -DSFML_STATIC
...
g++ -c ..\src\events.cpp -I..\SFML-2.5.1\include -DSFML_STATIC
g++ -c ..\src\game.cpp -I..\SFML-2.5.1\include -DSFML_STATIC
g++ -c ..\src\graphics.cpp -I..\SFML-2.5.1\include -DSFML_STATIC
...
g++ -c ..\src\utilities.cpp -I..\SFML-2.5.1\include -DSFML_STATIC
